...
class ToDo extends React.Component {
  ...
  callAPI = (url, method='get', body, handler, errorHandler) => {
    ...
    .catch((err) => typeof errorHandler === 'function' ? errorHandler(err) : console.error(err))
  }
  ...
  addItem = event => {
    ...
    this.setState({
      todoList: [...this.state.item, newItem]
    })
  ...
  deleteItem = id => {
    ...
    this.setState({
      todoList: this.state.todoList.filter(item => item._id)
    })
